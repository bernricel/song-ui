...
export default function MainContent({ songs, selectedSong, onSongSelect, loading, error, onRetry }) {
    ...
    <div className="flex-1 overflow-hidden flex flex-col lg:flex-row bg-dark">
      ...
      {selectedSong ? (
        ...
        <div className="lg:w-2/3 bg-black border-r border-gray-700 flex flex-col items-center justify-center">
          ...
          <p className="text-gray-400 text-xl font-semibold">Select a song to play</p>
          <p className="text-gray-500 text-sm mt-2">Click any song from the list below</p>
        </div>
      )}

      {/* Songs Grid/List Section */}
      <div className={`${selectedSong ? 'lg:w-1/3' : 'w-full'} overflow-y-auto bg-dark flex flex-col`}>
        <div className="p-6 flex-1 overflow-y-auto">
          <div className="flex items-center gap-2 mb-6 sticky top-0 bg-dark pt-2">
          ...
          {loading ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-gray-400 text-lg font-semibold">No songs found</p>
              <p className="text-gray-500 text-sm mt-2">Try searching for something different</p>
            </div>
          ) : (
